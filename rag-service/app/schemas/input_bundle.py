...
OutputPayload = dict[str, Any] | list[dict[str, Any]]
...
class ModelOutputs(BaseModel):
    ...
    pressing: OutputPayload | None = None
    passingNetwork: OutputPayload | None = None
    passingNewtork: OutputPayload | None = None
    lineBreaks: OutputPayload | None = None
    line_breaks: OutputPayload | None = None
    ballLosses: OutputPayload | None = None
    ball_losses: OutputPayload | None = None
